...
class ProcessWriteCommand extends Command {
    ...
    private function writeValue(Tag $tag, string $val) {
        ...
        switch ($tag->getType()) {
            ...
            case TagType::Byte: $ret = $this->parser->writeByte($tag->getName(), $val); break;
            case TagType::Word: $ret = $this->parser->writeWord($tag->getName(), $val); break;
            case TagType::DWord: $ret = $this->parser->writeDWord($tag->getName(), $val); break;
            case TagType::INT: $ret = $this->parser->writeInt($tag->getName(), $val); break;
            case TagType::REAL: $ret = $this->parser->writeReal($tag->getName(), $val); break;
        }
