...
class ChartDataReader {
    ...
    public function getData($data): array {
        ...
        switch ($data['sortMode']) {
            case 'lastData': $ret['data'] = $this->getLastData($data['sortData'], $tagLogger); break;
            case 'rangeData': $ret['data'] = $this->getRangeData($data['sortData'], $tagLogger); break;
            case 'currentData': $ret['data'] = $this->getCurrentData($data['sortData'], $tagLogger); break;
        }
