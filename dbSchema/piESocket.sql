...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=CURRENT_USER()*/ /*!50003 TRIGGER `tr1_log_BIT_1` AFTER INSERT ON `log_BIT_1` FOR EACH ROW UPDATE log_tags SET ltLastUPD = NEW.lbTimeStamp, ltLastValue = CAST(NEW.lbValue AS CHAR(50)) WHERE lttid = NEW.lbtid */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=CURRENT_USER()*/ /*!50003 TRIGGER `tr1_log_BIT_2` AFTER INSERT ON `log_BIT_2` FOR EACH ROW UPDATE log_tags SET ltLastUPD = NEW.lbTimeStamp, ltLastValue = CAST(NEW.lbValue AS CHAR(50)) WHERE lttid = NEW.lbtid */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=CURRENT_USER()*/ /*!50003 TRIGGER `tr1_log_BIT_3` AFTER INSERT ON `log_BIT_3` FOR EACH ROW UPDATE log_tags SET ltLastUPD = NEW.lbTimeStamp, ltLastValue = CAST(NEW.lbValue AS CHAR(50)) WHERE lttid = NEW.lbtid */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=CURRENT_USER()*/ /*!50003 TRIGGER `tr1_log_BIT_4` AFTER INSERT ON `log_BIT_4` FOR EACH ROW UPDATE log_tags SET ltLastUPD = NEW.lbTimeStamp, ltLastValue = CAST(NEW.lbValue AS CHAR(50)) WHERE lttid = NEW.lbtid */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
